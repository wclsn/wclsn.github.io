...
### <span style="color: #ff0000;">Please contact me with this email: shaonanwu[AT]stu.xjtu.edu.cn </span>
...
- **Alchemy: Amplifying Theorem-Proving Capability through Symbolic Mutation**
  ...
  <br> Arxiv Preprint.
  <br> We propose a CPU-only method to synthesize new theorems based on existing theorems, which shows promise in enhancing the theorem-proving ability of neural provers.
